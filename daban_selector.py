...
# ★ v3.1修复：量比上限从5.0提高至8.0（市场大涨时很多首板量比本来就大）
...
def kelly_position_advice(score: float, strategy: str = "", market_state: str = "",
    ...
    公式：Kelly = 胜率 - (1-胜率)/盈亏比，再乘评分系数 × 市场折扣 × 赚钱效应系数
    """
    # 按策略取对应参数
    ...
    notes = " | ".join(filter(None, [market_note, heat_note]))
